...
const {getProducts,getProductById, createproduct, updateProduct, deleteProduct, getProductBycategory} = require("../controllers/product.Controllers");

router.post("/api/createproducts", upload.single("image"),createproduct)
router.get("/api/products", getProducts);
router.get("/api/products/women", getProductBycategory);
